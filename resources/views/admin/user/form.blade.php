...
@section('content')
	<div class="row page-header">
		...
		<div class="col-sm-6 text-right padding-top-20">
			<a class="btn btn-default" href="{{ redirect()->getUrlGenerator()->previous() }}" title="Back"><i class="fa fa-arrow-left" ></i> Back</a>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
	<div class="panel panel-default">
		<div class="panel-body">
			<form class="form-horizontal" role="form" method="POST" action="{{ url('/teacher/user/form') }}">
